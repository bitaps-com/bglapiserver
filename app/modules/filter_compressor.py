...
from pybgl import bytes_to_int, sha256, map_into_range, siphash, double_sha256
from pybgl import ripemd160, int_to_var_int, encode_gcs
import time
import gzip
import traceback
...
class FilterCompressor():
    ...
    def __init__(self, dsn, logger):
        setproctitle('bglapi server: filter compressor')
